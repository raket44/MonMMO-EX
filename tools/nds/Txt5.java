...
public class Txt5{
 ...
 public static void main(String[] a)throws Exception{rom=Files.readAllBytes(Paths.get(a[0]));walk(u32(rom,0x40),0,"");List<String> t=decode(narcFile(a[1],Integer.parseInt(a[2])));System.out.println(a[1]+" file "+a[2]+" entries "+t.size());for(int i=0;i<Math.min(Integer.parseInt(a[3]),t.size());i++)System.out.println("  "+i+": "+t.get(i));}
