...
object WorldClock {
  ...
  /** Epoch second of today's midnight in [zone]: in-game midnight then falls every six real hours from it. */
  fun dayStartSecond(): Int = now().toLocalDate().atStartOfDay(zone).toEpochSecond().toInt()
