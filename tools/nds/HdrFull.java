...
public class HdrFull{
 ...
 public static void main(String[]a)throws Exception{
  ...
  for(int k=1;k<a.length;k++){
   int i=Integer.parseInt(a[k]);int o=i*48;
   System.out.printf("map %-4d:",i);
   for(int b=0;b<48;b++)System.out.printf(" %02x",h[o+b]);
   System.out.println();
   System.out.printf("  u16s: ");
   for(int b=0;b<48;b+=2)System.out.printf("%d ",u16(h,o+b));
   System.out.println();
  }
 }
